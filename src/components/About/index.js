      ...
      <>
         <div className='about-container'>
            ...
            <div className='about-content'>
               <div className='about-content-text'>En Virgi Borgna Fit Club nos atraviesa el arte en varias de sus formas, es un espacio para todos los amantes del movimiento, del canto, de la actuación.
