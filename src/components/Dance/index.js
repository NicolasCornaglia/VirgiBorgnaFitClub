...
const Dance = () => {
   const class1 = {
      ...
      charac: {
         ...
         dateTime: 'Lunes y Miércoles 8hs | 19:30hs / Martes y Jueves 13:15hs | 19:30hs',
         duration: '1h',
         wpp: '5493492289969',
      },
   ...
   const class2 = {
      ...
      charac: {
         ages: 'Consultar',
         dateTime: 'Martes y Jueves 10:30hs',
         duration: '1h',
         wpp: '5493492289969',
      },
   ...
   const class4 = {
      ...
      charac: {
         ages: 'De 7 a 11 años',
         dateTime: 'Martes y Jueves 17:30hs',
         duration: '1h',
         wpp: '5493492289969',
      },
      enroll: 'https://forms.gle/3Y4qG9xp5AfWiNLR8',
   ...
   const class5 = {
      ...
      charac: {
         ...
         dateTime: 'Lunes y Miércoles 16:30hs',
         duration: '1h',
         wpp: '5493492289969',
      },
   ...
   const class8 = {
      ...
      charac: {
         ages: 'A partir de los 12 años',
         dateTime: 'Martes y Jueves 16:30hs',
         duration: '1h',
         wpp: '5493401416919',
      },
      enroll: '',
